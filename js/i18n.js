  ...
  const dict = {
    en: {
      meta: {
        ...
        applyTitle: "Apply to Become a Founding Host | Nexa Stays",
        applyDesc:
          "Apply to become one of the first 100 Nexa Stays founding hosts in Morocco. Exclusive launch benefits, including 0% commission for your first 3 months.",
      },
      nav: {
        whyJoin: "Why Join",
        benefits: "Benefits",
      ...
      apply: {
        mobileEyebrow: "Founding Host Program · First 100",
        mobilePromo:
          "Join the first 100 hosts helping launch Nexa Stays across Morocco. Founding hosts receive exclusive launch benefits, including 0% commission for their first three months.",
        mobileBenefit1: "Priority onboarding",
        mobileBenefit2: "Featured visibility after launch",
        mobileBenefit3: "Dedicated local support",
        deskTitle: "Become a Founding Host",
        deskIntro:
          "Join the first 100 hosts helping launch Nexa Stays across Morocco. Founding hosts receive exclusive launch benefits, including 0% commission for their first three months.",
        benefit1Title: "Priority onboarding",
        benefit1Body: "Personal support to get your listing ready.",
        benefit2Title: "Featured visibility after launch",
        benefit2Body: "Early visibility reserved for founding hosts.",
        benefit3Title: "Dedicated local support",
        benefit3Body: "A Moroccan team that works directly with you.",
        deskFooter: "Limited to 100 founding hosts",
        formTitle: "Apply to Become a Founding Host",
        formSubtitle:
        ...
        footerBefore: "We'll only use this to review your founding host application. See our",
        footerAnd: "and",
        footerAfter: ".",
        ...
        successBody:
          "Thank you. Our hospitality team will review your founding host application and reach out within 48 hours.",
        successDone: "Done",
    ...
    fr: {
      meta: {
        ...
        applyTitle: "Candidature hôte fondateur | Nexa Stays",
        applyDesc:
          "Postulez pour devenir l'un des 100 premiers hôtes fondateurs Nexa Stays au Maroc. Avantages exclusifs de lancement, dont 0 % de commission pendant vos 3 premiers mois.",
      },
      nav: {
      ...
      apply: {
        mobileEyebrow: "Programme Hôtes fondateurs · 100 premiers",
        mobilePromo:
          "Rejoignez les 100 premiers hôtes qui lancent Nexa Stays au Maroc. Les hôtes fondateurs bénéficient d'avantages exclusifs de lancement, dont 0 % de commission pendant leurs trois premiers mois.",
        mobileBenefit1: "Onboarding prioritaire",
        mobileBenefit2: "Visibilité mise en avant après le lancement",
        mobileBenefit3: "Support local dédié",
        deskTitle: "Devenez hôte fondateur",
        deskIntro:
          "Rejoignez les 100 premiers hôtes qui lancent Nexa Stays au Maroc. Les hôtes fondateurs bénéficient d'avantages exclusifs de lancement, dont 0 % de commission pendant leurs trois premiers mois.",
        benefit1Title: "Onboarding prioritaire",
        benefit1Body: "Un accompagnement personnel pour préparer votre annonce.",
        benefit2Title: "Visibilité mise en avant après le lancement",
        benefit2Body: "Une visibilité anticipée réservée aux hôtes fondateurs.",
        benefit3Title: "Support local dédié",
        benefit3Body: "Une équipe marocaine qui travaille directement avec vous.",
        deskFooter: "Limité à 100 hôtes fondateurs",
        formTitle: "Candidature hôte fondateur",
        formSubtitle:
        ...
        submitting: "Envoi…",
        footerBefore: "Nous utilisons ces informations uniquement pour examiner votre candidature d'hôte fondateur. Consultez notre",
        footerAnd: "et nos",
        footerAfter: ".",
        ...
        successBody:
          "Merci. Notre équipe hospitalité examinera votre candidature d'hôte fondateur et vous contactera sous 48 heures.",
        successDone: "Terminé",
    ...
    ar: {
      meta: {
        ...
        applyTitle: "قدّم طلباً لتصبح مضيفاً مؤسساً | Nexa Stays",
        applyDesc:
          "قدّم طلباً لتصبح أحد أول 100 مضيف مؤسس على Nexa Stays في المغرب. مزايا إطلاق حصرية تشمل بدون عمولة خلال أول 3 أشهر.",
      },
      nav: {
        whyJoin: "لماذا تنضم",
        benefits: "المزايا",
      ...
      apply: {
        mobileEyebrow: "برنامج المضيفين المؤسسين · أول 100",
        mobilePromo:
          "انضم إلى أول 100 مضيف يساعدون في إطلاق Nexa Stays عبر المغرب. يحصل المضيفون المؤسسون على مزايا إطلاق حصرية، بما فيها بدون عمولة خلال أول ثلاثة أشهر.",
        mobileBenefit1: "انضمام ذو أولوية",
        mobileBenefit2: "ظهور مميز بعد الإطلاق",
        mobileBenefit3: "دعم محلي مخصص",
        deskTitle: "كن مضيفاً مؤسساً",
        deskIntro:
          "انضم إلى أول 100 مضيف يساعدون في إطلاق Nexa Stays عبر المغرب. يحصل المضيفون المؤسسون على مزايا إطلاق حصرية، بما فيها بدون عمولة خلال أول ثلاثة أشهر.",
        benefit1Title: "انضمام ذو أولوية",
        benefit1Body: "دعم شخصي لتجهيز إعلانك.",
        benefit2Title: "ظهور مميز بعد الإطلاق",
        benefit2Body: "ظهور مبكر محفوظ للمضيفين المؤسسين.",
        benefit3Title: "دعم محلي مخصص",
        benefit3Body: "فريق مغربي يعمل مباشرة معك.",
        deskFooter: "محدود بـ 100 مضيف مؤسس",
        formTitle: "قدّم طلباً لتصبح مضيفاً مؤسساً",
        ...
        footerBefore: "نستخدم هذه المعلومات فقط لمراجعة طلب المضيف المؤسس. اطّلع على",
        footerAnd: "و",
        footerAfter: ".",
        ...
        successBody:
          "شكراً لك. سيراجع فريق الضيافة طلب المضيف المؤسس ويتواصل معك خلال 48 ساعة.",
        successDone: "تم",
